...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/PaginatedScrollView/PaginatedScrollView.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/ReachabilitySwift/Reachability.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/SwiftLocation/SwiftLocation.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/SwiftNotes/SwiftNotes.framework"
